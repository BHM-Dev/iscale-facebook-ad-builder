...
def upgrade() -> None:
    ...
    op.execute("CREATE INDEX IF NOT EXISTS ix_scraped_ads_last_seen ON scraped_ads (last_seen DESC)")
    op.execute("CREATE INDEX IF NOT EXISTS ix_scraped_ads_cta_type ON scraped_ads (cta_type)")
    op.execute("CREATE INDEX IF NOT EXISTS ix_scraped_ads_page_type ON scraped_ads (page_type)")
